...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("number_to_delete", type=int, help="Number of the oldest studies to delete")
    parser.add_argument("--pause", action="store_true", help="Pause prior to deleting each study")
...
if __name__ == "__main__":
    ...
    for i, study in enumerate(sorted(studies, key=lambda x: x.received_time)):  # type: ignore
