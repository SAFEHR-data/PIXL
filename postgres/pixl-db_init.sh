...
columns_and_types="mrn text, accession_number text, image_identifier text, age integer, sex text, ethnicity text, height real, weight real, gcs integer, xray_report text"
